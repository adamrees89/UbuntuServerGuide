...
This configuration will create a Samba share called "Shared" that points to the directory \texttt{/home/user/shared}. The share will be available to the user "user", and it will allow read and write access. The share will also be browsable and public, meaning that it can be accessed by anyone on the network.
