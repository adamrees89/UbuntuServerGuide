...
This section will outline some of the basic methods for monitoring network traffic on your LAN. For monitoring network traffic on your servr, please refer to Section~\ref{sec:monitoring}. This section is useful for checking if there are unusual devices on your home network.
